...
string_length = len("The main goal of supply chain is to ship the goods to the end consumer/vendor/distributor/manufacturer at the right time with out any disruptions. The foundational key activity in supply chain is planning. There are various teams involved in the end to end supply chain, starting from planning team, procurement, ware house management, transportation , logistics, analytics and so on at a high level.  At each and every step, so many people involved, and many systems needs to work together. The data is key in modern supply chain and it it not restricted to only internal data, it should include or consider external data Geo Political, trade wars, tarrifs, inflation, supply, demand, government, local demands, consumer trends, competitions,  latest trends or technical advancements, weather, and so on AI: AI can solve lot of complex problems and provide actionable insighs, such as . Inventory optimization . Order placement based supply and demand . Demand forecasting . Reduce the operational costs by optimizing the tasks")
print(string_length)